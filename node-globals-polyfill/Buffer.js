...
if (!Buffer.prototype.readUint24BE) {
    Buffer.prototype.readUint24BE = Buffer.prototype.readUInt24BE = function readUint24BE(
        offset,
        noAssert,
    ) {
        offset = offset >>> 0
...
if (!Buffer.prototype.writeUint24BE) {
    Buffer.prototype.writeUint24BE = Buffer.prototype.writeUInt24BE = function writeUInt24BE(
        value,
        offset,
        noAssert,
    ) {
...
if (!Buffer.prototype.writeBigUInt64BE && typeof BigInt !== 'undefined') {
    ...
    Buffer.prototype.writeBigUInt64BE = function writeBigUInt64BE(
        value,
        offset = 0,
    ) {
        ...
        if (value > max || value < min) {
            ...
            if (byteLength > 3) {
                if (min === 0 || min === BigInt(0)) {
                    range = `>= 0${n} and < 2${n} ** ${(byteLength + 1) *
                        8}${n}`
                } else {
                    range =
                        `>= -(2${n} ** ${(byteLength + 1) * 8 -
